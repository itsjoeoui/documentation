...
- **`vendor`**: The DAQ vendor (NI, LABJACK_T_SERIES, MCC, or KEYSIGHT_34980)
- **`resource`**: Device identifier
  - For NI, LabJack, and MCC: string (device name, serial number, or IP address. Vendor specific resource identifier.)
...
daq = NominalDAQ.create(
    name="mccDAQ",
    vendor=DAQVendor.MCC,
    resource="344371:0"  # "<unique_id>" or "<unique_id>:<board_number>"
)
