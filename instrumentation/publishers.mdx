...
For example, when you call `NominalPSU.get_voltage()`, this not only queries the instrument for the voltage but also causes all attached Publishers to publish the measurement response automatically.
...
from nominal_instro.lib.types import Measurement, Command
...
```python
from nominal_instro.instruments import NominalDAQ
from nominal_instro.lib.publishers.nominal_connect import NominalConnectPublisher
from nominal_instro.instruments.daq.types import DAQVendor
...
from nominal_instro.instruments import NominalDAQ
from nominal_instro.instruments.daq.types import DAQVendor
from nominal_instro.lib.publishers import FilePublisher
...
```python
from nominal_instro.lib.publishers import FilePublisher, NominalCorePublisher
...
from nominal_instro.lib.publishers import BasicBufferedPublisher
from nominal_instro.lib.types import Measurement, Command
...
print_publisher = PrintChannelPublisher(channel_name="myPSU_ch1_i")
...
import time
from nominal_instro.instruments import NominalPSU
from nominal_instro.lib.publishers import QueuedPublisher
from nominal_instro.lib.types import Measurement, Command
